...
class TwigFileExtractor implements FileVisitorInterface, \Twig_NodeVisitorInterface
{
    ...
    public function enterNode(\Twig_NodeInterface $node, \Twig_Environment $env)
    {
        ...
        // this code finds variable named 'dom', which can be used as dynamic domain name
        ...
        if ($node instanceof \Twig_Node_Set) {
            ...
            if ($varName == 'dom') {
                $value = $node->getNode('values')->getNode(0)->getAttribute('value');
                $this->domainFromVariable = $value;
            }
        }
